    ...
    <SiteLayout>
      <section className="relative py-24">
        <div className="container mx-auto text-center">
          ...
          <p className="mx-auto mt-6 text-white/95 drop-shadow-[0_2px_0_rgba(0,0,0,0.55)] font-display whitespace-nowrap text-xs sm:text-sm md:text-base animate-enter-blur" style={{ animationDelay: "120ms" }}>
            Cooming soon!!!{" "}
            <a
