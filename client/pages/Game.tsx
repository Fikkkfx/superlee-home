    ...
    <SiteLayout>
      <section className="relative py-24">
        <div className="container mx-auto px-4">
          ...
          <p
            className="mx-auto mt-3 max-w-2xl text-center text-white/90 animate-enter-blur"
              ...
              g.disabled ? (
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="mt-1 text-sm text-white/85 drop-shadow-[0_2px_0_rgba(0,0,0,0.35)]">
                      {g.description}
                    </p>
                    <div className="mt-4 text-xs font-extrabold text-sky-200 opacity-0 transition group-hover:opacity-100">
                      Play →
                    </div>
                  </div>
